...
public class GetAndTraverse_complete {
...
//        File f1 = new File("E:\\chenlinxin\\bbb");
//        //注意是 list 的返回值是 String 类型的
//        String[] arr2 = f1.list();
//        for (String s : arr2) {
...
//        }
        ...
        //需求：我现在要获取E:\\chenlinxin\\bbb文件夹里面所有的txt文件
        File f2 = new File("E:\\chenlinxin\\bbb");
